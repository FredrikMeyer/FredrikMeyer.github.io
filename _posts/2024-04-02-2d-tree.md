...
![2-d tree tree structure](/assets/2dtree.png)
...
![Subregions of a 2-d tree structure](/assets/2dtree_coord.png)
...
When implementing `TwoTree`, I took a lot of inspiration (and implementation) from [this blog post](https://wallace.fm/blog/2016/byod-party/) by Nathan Wallace.
